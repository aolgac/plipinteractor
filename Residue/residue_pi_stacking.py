...
pi_stacking["COUNT_by_source"] = pi_stacking.groupby(["RESNR","RESTYPE","RESCHAIN","RESNR_LIG","RESTYPE_LIG","RESCHAIN_LIG","SOURCE"]).transform("size")
pi_s=pi_stacking.groupby(["RESNR","RESTYPE","RESCHAIN","RESNR_LIG","RESTYPE_LIG","RESCHAIN_LIG","INTERACTION TYPE",'SOURCE']).size().reset_index(name='COUNT_by_source')
# count overall occurences
pi_s["COUNT"] = pi_s.groupby(["RESNR","RESTYPE","RESCHAIN","RESNR_LIG","RESTYPE_LIG","RESCHAIN_LIG"]).transform("size")
...
p_s=pi_s.groupby(["RESNR","RESTYPE","RESCHAIN","RESNR_LIG","RESTYPE_LIG","RESCHAIN_LIG","INTERACTION TYPE","COUNT"])['SOURCES'].apply(lambda x: '|'.join(x)).reset_index()
